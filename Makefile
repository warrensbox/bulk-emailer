EXE  := bulk-emailer
PKG  := github.com/warrensbox/bulk-emailer
VER := $(shell git ls-remote --tags git://github.com/warrensbox/bulk-emailer | awk '{print $$2}'| awk -F"/" '{print $$3}' | sort -n -t. -k1,1 -k2,2 -k3,3 | tail -n 1)
PATH := build:$(PATH)
